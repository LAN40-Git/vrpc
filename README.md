## 目录
- [1. 简介](#1-简介)
  - [1.1. vRPC 特点](#11-vrpc特点)
  - [1.2. 协议报文支持](#12-协议报文支持)
- [2. 性能测试](#2-性能测试)
- [3. 安装 vRPC](#3-安装-vrpc)
  - [3.1. cmake](#31-cmake)
    - [3.1.1. 安装](#311-安装)
    - [3.1.2. 卸载](#312-卸载)
- [4. 快速使用](#4-快速使用)
  - [4.1. 搭建一个基于内置协议的 RPC 服务](#41-搭建一个基于内置协议的-rpc-服务)
    - [4.1.1. 准备 protobuf 文件](#411-准备-protobuf-文件)
    - [4.1.2. 编写业务代码并启动/请求 RPC 服务](#412-编写业务代码并启动请求-rpc-服务)
    - [4.1.3. 测试结果](#413-测试结果)
  - [4.2. 搭建一个基于 HTTP 协议的 RPC 服务](#42-搭建一个基于-http-协议的-rpc-服务)
- [5. 设计](#5-设计)
  - [5.1. 协议报文设计](#51-协议报文设计)
    - [5.1.1. 内置协议报文设计](#511-内置协议报文设计)
  - [5.2. 整体框架图（AI 生成）](#52-整体框架图ai-生成)
- [6. 正在完善...](#6-正在完善)
